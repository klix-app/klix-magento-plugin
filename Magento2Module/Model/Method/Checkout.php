...
namespace SpellPayment\ExpressCheckout\Model\Method;
...
class Checkout extends \Magento\Payment\Model\Method\AbstractMethod
{
    ...
    /**
     * @var \SpellPayment\ExpressCheckout\Helper\SpellAPIFactory
     */
    ...
    public function __construct(
        ...
        \SpellPayment\ExpressCheckout\Helper\Data $moduleHelper,
        \Magento\Framework\Locale\ResolverInterface $localeResolver,
        \SpellPayment\ExpressCheckout\Helper\SpellAPIFactory $spellAPIFactory,
    ...
    {
        if ($this->_checkoutSession->get_expressCheckout()) {
            $this->_checkoutSession->set_expressCheckout(false);
            return $this;
        }
