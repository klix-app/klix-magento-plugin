...
/**
 * Factory class for @see \SpellPayment\ExpressCheckout\Helper\SpellAPI
 */
class SpellAPIFactory
{
    ...
    public function __construct(
        ...
        $instanceName = \SpellPayment\ExpressCheckout\Helper\SpellAPI::class
    ) {
     ...
     *
     * @param array $data
     * @return \SpellPayment\ExpressCheckout\Helper\SpellAPI
    ...
    public function create(array $data = [])
    {
        ...
        if (!$instanceData['private_key'] || !$instanceData['brand_id']) {
            throw new AuthenticationException(__(
                'Shop authentication token/brand id of Klix E-commerce Gateway are not set'
            ));
        }
