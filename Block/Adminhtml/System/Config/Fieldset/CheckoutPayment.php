...
class CheckoutPayment extends \Magento\Config\Block\System\Config\Form\Fieldset
{
    ...
    {
        $html =
            "<div class=\"config-heading {$this->getBlockHeadCssClass()}\" ><div class=\"headingSpellPayment\"><strong>"
            . $element->getLegend();
        ...
        $html .= '<div class="button-container"><button type="button"' .
            ...
            '" id="' .
            $htmlId .
            '-head" onclick="spellPaymentToggleSolution.call(this, \'' .
    ...
    protected function _getExtraJs($element)
    {
        $script = "require(['jquery', 'prototype'], function(jQuery){
            window.spellPaymentToggleSolution = function (id, url) {
